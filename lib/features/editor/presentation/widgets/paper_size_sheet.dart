...
Future<PaperSize?> showPaperSizeSheet(
  BuildContext context, {
  required PaperSize current,
}) {
  return showModalBottomSheet<PaperSize>(
    context: context,
    isScrollControlled: true,
    showDragHandle: true,
    builder: (_) => _PaperSizeSheet(current: current),
  );
}

class _PaperSizeSheet extends StatefulWidget {
  const _PaperSizeSheet({required this.current});

  final PaperSize current;

  @override
  State<_PaperSizeSheet> createState() => _PaperSizeSheetState();
}

class _PaperSizeSheetState extends State<_PaperSizeSheet> {
  late PaperSize _selected;
  ...
  bool get _isCustomSelected => _selected.id == PaperSize.custom.id;
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              ...PaperSize.selectableSizes.map(_buildTile),
              AnimatedSwitcher(
  ...
  Widget _buildTile(PaperSize size) {
    final isSelected = size.id == _selected.id;
    return ListTile(
      ...
      subtitle: Text(size.dimensionLabel),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'Ukuran melebihi halaman akan diskalakan agar tetap muat.',
